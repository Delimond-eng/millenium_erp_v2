    ...
    <div class="authincation d-flex flex-column flex-lg-row flex-column-fluid">
		<div class="login-aside text-center d-none d-sm-flex flex-column flex-row-auto">
			<div class="d-flex flex-column-auto flex-column pt-lg-40 pt-15">
				...
				<p>Inscrivez-vous pour gerer et controler toute votre société !</p>
			</div>
					...
					<div class="row d-flex justify-content-center h-100 align-items-center">
						<div class="col-xl-10">
							<div class="auth-form">
								...
								<h4 class="text-center mb-4">Informations de la société</h4>
								<form class="row" action="/">
									...
									<div class="mb-3 col-md-6">
										<label class="mb-1 form-label">Logo de l'entreprise</label>
								...
								<div class="new-account mt-3 text-center">
									<p>Vous avez un compte ? <a class="text-primary" href="/sign_in">Connectez-vous</a></p>
								</div>
                            </div>
						</div>
					</div>
