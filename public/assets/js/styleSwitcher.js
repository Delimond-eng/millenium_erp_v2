...
(function($) {
    ...
    themeDirectionSelect.on('change', function() {
		...
		if(this.value == 'rtl'){
			jQuery('.main-css').attr('href','https://kubayar.dexignzone.com/xhtml/error-404.html');
		}else{
