...
<head>
    <!-- PAGE TITLE HERE -->
	<title>Millenium ERP V2 | Login</title>
	<meta charset="utf-8">
		...
		<div class="login-aside text-center d-none d-sm-flex flex-column flex-row-auto">
			<div class="d-flex flex-column-auto flex-column pt-lg-40 pt-15">
				<div class="text-center mb-4 pt-5">
					<a href="index-2.html"><img src="images/logo-full.png" class="dark-login"  alt=""></a>
					<a href="index-2.html"><img src="images/logo-full-white.png" class="light-login" alt=""></a>
				</div>
				<h3 class="mb-2 text-uppercase fw-bold">Bienvenue sur <span class="text-primary">Millenium ERP</span> !</h3>
				<p>Utilisez vos identifiants <br>d'authentification pour vous connecter</p>
			</div>
						...
						<div class="col-xl-12">
							<div class="auth-form">
								...
								<form action="/">
									...
									<div class="mb-3">
										...
										<div class="position-relative">
											<input type="password" id="dz-password" class="form-control" placeholder="Mot de passe...">
								...
								<div class="new-account mt-3 text-center">
									<p>Vous n'avez pas un compte ? <a class="text-primary" href="/sign_up">Inscrivez-vous</a></p>
								</div>
                            </div>
						</div>
					</div>
...
</html><?php /**PATH C:\Users\Delimond\Documents\DEVFOLDER\PHP\erpa-v2\src\Views/auth/signin.blade.php ENDPATH**/ ?>