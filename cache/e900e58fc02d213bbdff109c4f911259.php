<ul class="metismenu menu-section" id="menu-facturation">
    ...
    <li class="<?php echo e(isActive(["/factures", "/facture_create"]) ? 'mm-active' : ''); ?>"><a class="has-arrow" href="javascript:void(0);" aria-expanded="false">
            <i class="flaticon-layout"></i>
...
</ul><?php /**PATH C:\Users\Delimond\Documents\DEVFOLDER\PHP\erpa-v2\src\Views/components/menus/factmenu.blade.php ENDPATH**/ ?>