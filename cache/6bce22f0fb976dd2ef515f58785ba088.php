            ...
            <div class="col-xl-12">
                <div class="table-responsive fs-14">
                    <table class="table card-table display mb-4 dataTablesCard " id="example5">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $factures; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $aff): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td>
                                    <div class="form-check">
                                ...
                                <td><span class="text-black font-w600">#<?php echo e($aff->ref); ?></span></td>
                                <td><span class="text-black text-nowrap"><?php echo e($aff->date); ?></span></td>
                                <td>
                                    <div>
                                        <h6 class="fs-16 text-black font-w600 mb-0 text-nowrap"> <?php echo e(reduceText($aff->libelle, 30)); ?></h6>
                                        <span class="fs-14"><?php echo e($aff->numero_cpte); ?></span>
                                    </div>
                                </td>
                                <td><span class="text-black"><?php echo e($aff->total_du); ?></span></td>
                                <td><span class="text-black"><?php echo e($aff->total_paye); ?></span></td>
                                <td><span class="text-black"><?php echo e($aff->note_credit_montant); ?></span></td>
                                <td><a href="javascript:void(0)" class="badge badge-sm <?php echo e($aff->total_paye < $aff->total_du ? 'badge-danger' : 'badge-success'); ?>" ><?php echo e($aff->total_paye < $aff->total_du ? 'Non reglée' : 'Reglée'); ?></a></td>
                                <td>
                                    <div class="dropdown">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make("layouts.app", array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Delimond\Documents\DEVFOLDER\PHP\erpa-v2\src\Views/pages/fac/facList.blade.php ENDPATH**/ ?>